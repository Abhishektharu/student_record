...
<div class="container">
  ...
  <a href="viewfaculty.php" class='btn btn-outline-dark mb-2'> <i class=""></i> View faculty</a>
  <a href="courseadd.php" class='btn btn-outline-dark mb-2'> <i class="bi bi-person-plus"></i> Add subject</a>
  <a href="viewcourse.php" class='btn btn-outline-dark mb-2'> <i class=""></i> View subject</a>
  <a href="logout.php" class='btn btn-outline-dark mb-2'> <i class=""></i>Logout here </a>
